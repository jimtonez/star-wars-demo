...
const Character = ( char: Build ) => {
    ...
    return (
        <div className={`col-span-1 border border-gray-700 backdrop-blur-sm bg-gray-800/20 rounded-full cursor-pointer shadow-lg shadow-black ease-in-out duration-300 mb-4`}>
