...
export default function Mission ( mission: Mission) {
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <Link href={`/missions/${missionName}`} ref={hoverRef as React.RefObject<HTMLDivElement>} className={`flex ${mission.enabled ? 'cursor-pointer' : ''} flex-col col-span-1 h-full w-auto lg:w-full border ${!isHovered ? 'border-yellow-600 bg-inherit' : 'border-gray-700 bg-gray-800/20 scale-[101%]'} rounded-xl shadow-lg shadow-black`}>
