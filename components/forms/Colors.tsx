...
export default function Colors () {
    ...
    return (
        <div className="grid items-center justify-center grid-cols-4 grid-rows-2 sm:grid-cols-8 lg:grid-cols-4 sm:grid-rows-1 lg:grid-rows-2 gap-4 sm:gap-4 h-24 sm:h-16 md:h-20 lg:h-40 w-full pl-6 sm:pl-0 lg:w-[350px] z-10">
            {colors.map((color, i) => (
