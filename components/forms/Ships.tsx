                ...
                <div className="flex flex-col col-span-1 lg:col-span-2 items-center justify-center">
                    {character ? (
                        <div className="flex flex-col w-full lg:w-[450px] h-auto items-center justify-start space-y-4 mt-4 lg:mt-12">
                            <div className="flex relative w-full flex-row items-center justify-around space-x-10 lg:space-x-0 lg:space-x-4 lg:justify-center">
                                ...
                                <button disabled={!ship} className={`flex lg:hidden w-auto items-center justify-center mb-12 sm:px-2 sm:py-2 rounded-3xl bg-inherit border border-yellow-600 shadow-lg shadow-black hover:border-gray-700 transition hover:bg-zinc-800/30 hover:opacity-80 hover:scale-[102%] z-10`} onClick={() => setCurrentStep("Submit")}>
                            ...
                            <div className="hidden lg:flex lg:flex-row w-full pt-20 items-center justify-around">
                                ...
                                <button disabled={!ship} className={`${!ship ? 'hidden' : 'flex'} w-1/2 items-center justify-center px-6 py-3 rounded-xl bg-inherit border border-yellow-600 shadow-lg shadow-black hover:border-gray-700 transition hover:bg-zinc-800/30 hover:opacity-80 hover:scale-[102%]`} onClick={() => setCurrentStep("Submit")}>
                                    <span className="font-semibold text-teal-400 text-lg">Continue</span>
                                </button>
                            </div>
                        </div>
                    ) : (
