...
export default function Profile () {
    ...
    return (
        <>
            <RecoilRoot>
                <div className="flex flex-col items-center justify-between h-full scrollbar-hide">
                    ...
                    <UserProfile username={user.user_name} name={user.character_name} image={user.image} shipImage={user.ship_url} color={user.color} />
                    <Dashboard />
                    <Footer />
                </div>
            </RecoilRoot>
